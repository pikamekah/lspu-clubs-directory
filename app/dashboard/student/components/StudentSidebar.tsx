...
export default function StudentSidebar({
  ...
  return (
    <aside className="w-full lg:w-[260px] bg-white lg:h-screen lg:sticky lg:top-0 flex flex-col shrink-0 shadow-sm border-b lg:border-b-0 lg:border-r border-cyan-100">
